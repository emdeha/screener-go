...
type FakeCompanyImporter struct {
...
func (fake *FakeCompanyImporter) DoImport(arg1 context.Context) error {
...
func (fake *FakeCompanyImporter) DoImportCallCount() int {
	fake.doImportMutex.RLock()
	defer fake.doImportMutex.RUnlock()
	return len(fake.doImportArgsForCall)
}

func (fake *FakeCompanyImporter) DoImportCalls(stub func(context.Context) error) {
	fake.doImportMutex.Lock()
	defer fake.doImportMutex.Unlock()
	fake.DoImportStub = stub
}

func (fake *FakeCompanyImporter) DoImportArgsForCall(i int) context.Context {
	fake.doImportMutex.RLock()
	defer fake.doImportMutex.RUnlock()
...
func (fake *FakeCompanyImporter) DoImportReturns(result1 error) {
	fake.doImportMutex.Lock()
	defer fake.doImportMutex.Unlock()
...
func (fake *FakeCompanyImporter) DoImportReturnsOnCall(i int, result1 error) {
	fake.doImportMutex.Lock()
	defer fake.doImportMutex.Unlock()
	fake.DoImportStub = nil
...
func (fake *FakeCompanyImporter) Invocations() map[string][][]interface{} {
...
func (fake *FakeCompanyImporter) recordInvocation(key string, args []interface{}) {
...
var _ usecases.CompanyImporter = new(FakeCompanyImporter)
